...
#macro SLANG_AUTO_INSERT_DIRECTORY_SLASH true      // When a slash is not detected at the end of SLANG_DIRECTORY, this will automatically insert one

#macro SLANG_FILE_COMMENT_PREFIX "//"     // What must come at the start of a line to be considered a comment
#macro SLANG_FILE_TEXT_SEPARATOR ":"	      // What must come inbetween the key and the text to denote separation
